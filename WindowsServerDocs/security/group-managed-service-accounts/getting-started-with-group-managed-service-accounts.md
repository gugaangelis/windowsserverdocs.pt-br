...
|Conta de Computador sem o sistema do Windows|Domínio|Qualquer servidor ingressado no domínio|Não|
...
|Conta de Usuário|Domínio|Qualquer servidor ingressado no domínio|Não|
