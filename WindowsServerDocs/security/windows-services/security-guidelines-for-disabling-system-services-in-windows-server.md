...
| **Tipo de inicialização** | Manual |
| **Recomendação** | Pode ser desabilitado |
| **Comentários** | Pode ser desabilitado se não é usado. Outro mecanismo de desabilitação: [Desabilitar o Bluetooth e a transmissão por infravermelho](/previous-versions/tn-archive/dd252791(v=technet.10)) |
