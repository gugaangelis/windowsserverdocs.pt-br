...
ms.locfileid: "6121445"
---
# Segurança e garantia no Windows Server 
...
### [Postagem no blog de segurança do Windows Server](https://blogs.technet.microsoft.com/windowsserver/2016/04/25/ten-reasons-youll-love-windows-server-2016-8-security/)
...
### [Blog de segurança de nuvem privada e datacenter](https://blogs.technet.microsoft.com/datacentersecurity/)
Esse é o site de blog central para conteúdo técnico da equipe de segurança de nuvem privada e datacenter da Microsoft.                                    

### [Abordar ameaças emergentes e mudanças de paisagem](https://www.youtube.com/watch?v=B5JMYxYWx1k&feature=youtu.be)
...
### [Postagem do blog sobre como protegendo seu datacenter e nuvem de ameaças emergentes](http://blogs.technet.com/b/windowsserver/archive/2015/11/18/protecting-your-datacenter-and-cloud-november-update.aspx)
...
### [Sessão Visão geral sobre segurança e garantia no Ignite](http://channel9.msdn.com/events/ignite/2015/brk2482)
Esta sessão do Ignite aborda as ameaças persistentes, as violações internas, o crime cibernético organizado e a proteção da Plataforma Microsoft Cloud (serviços locais e conectados com o Azure). Ela inclui cenários para proteger cargas de trabalho, locatários de grandes empresas e provedores de serviços.                                                                   

## Virtualização segura com VMs blindadas

### [VM blindada no Channel 9](http://channel9.msdn.com/Shows/Mechanics/Introduction-to-Shielded-Virtual-Machines-in-Windows-Server-2016)
Um passo a passo de tecnologia e de benefícios de VM blindada.                           

### [Demonstração de VM blindada](https://www.youtube.com/watch?v=xip5Qtk-7d8)
...
### [Passo a passo em vídeo de máquinas virtuais blindadas no Windows Server](http://microsoft-cloud.cloudguides.com/Guides/Shielded Virtual Machines in Windows Server.htm)
...
### [Proteção da malha: proteção de segredos de locatário no Hyper-V (vídeo do Ignite)](http://channel9.msdn.com/events/ignite/2015/brk3457)
...
### [Guia de implantação de malha protegida](https://docs.microsoft.com/windows-server/virtualization/guarded-fabric-shielded-vm/guarded-fabric-deploying-hgs-overview)
...
### [VM blindada e malha protegida em filiais](https://docs.microsoft.com/windows-server/virtualization/guarded-fabric-shielded-vm/guarded-fabric-manage-branch-office)
...
### [Guia de solução de problemas de VM blindada e malha protegida](https://docs.microsoft.com/windows-server/virtualization/guarded-fabric-shielded-vm/guarded-fabric-troubleshoot-overview)
Este guia fornece informações sobre como resolver problemas que você pode encontrar em seu ambiente de VM blindada.

### [Artigo de VM blindada](http://windowsitpro.com/hyper-v/super-secure-hyper-v-environments-shielded-vms-2016)
...
### [Proteger o acesso privilegiado](https://technet.microsoft.com/windows-server-docs/security/securing-privileged-access/securing-privileged-access)
...
### [Administração Just in Time com o Microsoft Identity Manager](https://technet.microsoft.com/library/mt150258.aspx)
...
### [Proteger o Windows e o Microsoft Azure Active Directory com Gerenciamento de Acesso Privilegiado](http://channel9.msdn.com/events/ignite/2015/brk3873)
...
### [Artigo sobre JEA (Administração Just Enough)](http://aka.ms/JEA)
...
### [Vídeo de demonstração sobre JEA (Administração Just Enough)](https://www.youtube.com/watch?v=xnBrbkY9P20)
Passo a passo da demonstração da Administração Just Enough.                                                                                                                  
## Proteção de credenciais

### [Proteger credenciais de domínio derivadas com o Credential Guard](https://docs.microsoft.com/windows/security/identity-protection/credential-guard/credential-guard)
...
### [Proteger as credenciais de Área de Trabalho Remota com o Remote Credential Guard](https://docs.microsoft.com/windows/security/identity-protection/remote-credential-guard)
...
### [Vídeo de demonstração do Credential Guard](https://www.youtube.com/watch?v=eUpKOGSl7yk)
Este vídeo de cinco minutos demonstra o Credential Guard e o Remote Credential Guard.         

## Proteção do sistema operacional e de aplicativos
### [Guia de implantação do WDAC (Controle de Aplicativos do Windows Defender)](https://docs.microsoft.com/windows/security/threat-protection/windows-defender-application-control/windows-defender-application-control)
...
### [Vídeo de demonstração do Device Guard](https://www.youtube.com/watch?v=F-pTkesjkhI)
...
### [Configurações do Registro do protocolo TLS](https://docs.microsoft.com/windows-server/security/tls/tls-registry-settings)
...
### [Proteção de Fluxo de Controle](https://docs.microsoft.com/windows/desktop/SecBP/control-flow-guard)
...
### [Análise de ameaças de segurança usando o Microsoft Operations Management Suite](https://channel9.msdn.com/events/ignite/2015/brk3464)
...
### [Visão geral do firewall do datacenter](https://technet.microsoft.com/library/dn920240.aspx)
...
### [Novidades do DNS no Windows Server](https://technet.microsoft.com/windows-server-docs/networking/dns/what-s-new-in-dns-server)
Este tópico de visão geral fornece descrições breves dos novos recursos de DNS, com links para saber mais.                                                                           

## Mapear recursos de segurança com regulamentos de conformidade
