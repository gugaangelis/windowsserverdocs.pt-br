...
| Sizing | Cada nó de servidor HGS de tamanho médio (8 núcleos/4 GB) pode lidar com hosts Hyper-V 1.000. |
...
| SO | É recomendável usar a opção Server Core para o sistema operacional do host Hyper-V. |
