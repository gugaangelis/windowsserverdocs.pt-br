...
> [!IMPORTANT]
> Para desabilitar completamente o UAC, você deve desabilitar o controle de conta **User da política: Execute todos os administradores no modo de aprovação de administrador @ no__t-0.
