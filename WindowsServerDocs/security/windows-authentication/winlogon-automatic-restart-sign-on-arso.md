...
![Captura de tela mostrando a configuração de política controla a interface do usuário, onde você pode especificar se um dispositivo será automaticamente entrada do último usuário interativo depois que o sistema for reiniciado Windows Update](../media/winlogon-automatic-restart-sign-on-arso/GTR_ADDS_SignInPolicy.gif)  
