...
![Captura de tela mostrando onde verificar * * conta é confidencial e não pode ser delegada * * elemento de interface do usuário](../media/how-to-configure-protected-accounts/ADDS_ProtectAcct_TshootDelegation.gif)  
