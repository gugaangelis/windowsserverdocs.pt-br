...
Para obter informações sobre como uma relação de confiança funciona, consulte [como as relações de confiança de domínio e floresta funcionam](https://technet.microsoft.com/library/cc773178(v=ws.10).aspx).
