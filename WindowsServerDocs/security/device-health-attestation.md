...
### <a name="dha-service"></a>DHA service
...
#### <a name="dha-cloud-service"></a>DHA cloud service
...
#### <a name="dha-on-premises-service"></a>DHA on-premises service
...
#### <a name="dha-azure-cloud-service"></a>DHA Azure cloud service
...
### <a name="dha-validation-modes"></a>DHA validation modes
...
#### <a name="ekcert-validation-mode"></a>EKCert validation mode
...
Um arquivo de exemplo é [https://tpmsec.microsoft.com/OnPremisesDHA/TrustedTPM.cab](https://tpmsec.microsoft.com/OnPremisesDHA/TrustedTPM.cab).

#### <a name="aikcert-validation-mode"></a>AIKCert validation mode
...
## <a name="install-and-configure-the-dha-service-on-windows-server-2016"></a>Install and configure the DHA service on Windows Server 2016
...
### <a name="install-windows-server-2016"></a>Install Windows Server 2016
...
3.  No **selecionar o tipo de instalação** página, clique em **instalação baseada em função ou recurso baseado**e clique em **próxima**.
...
7.  Clique em **próxima**.
8.  Sobre o **Selecione recursos** página, clique em **próxima**.
9.  Sobre o **função Web Server (IIS)** página, clique em **próxima**.
10. Sobre o **selecione Serviços de função** página, clique em **próxima**.
11. On the **Device Health Attestation Service** page, click **Next**.
12. Sobre o **confirmar seleções de instalação** página, clique em **instalar**.
13. When the installation is done, click **Close**.

### <a name="install-the-signing-and-encryption-certificates"></a>Install the signing and encryption certificates
...
### <a name="install-the-trusted-tpm-roots-certificate-package"></a>Install the trusted TPM roots certificate package
...
#### <a name="download-the-trusted-tpm-roots-certificate-package"></a>Download the trusted TPM roots certificate package

Antes de instalar o pacote de certificado, você pode baixar a lista mais recente de raízes confiáveis do TPM de [https://tpmsec.microsoft.com/OnPremisesDHA/TrustedTPM.cab](https://tpmsec.microsoft.com/OnPremisesDHA/TrustedTPM.cab).

> **Important:** Before installing the package, verify that it is digitally signed by Microsoft.

#### <a name="extract-the-trusted-certificate-package"></a>Extract the trusted certificate package
...
#### <a name="remove-the-trust-chains-for-tpm-vendors-that-are-not-trusted-by-your-organization-optional"></a>Remove the trust chains for TPM vendors that are *not* trusted by your organization (Optional)
...
#### <a name="install-the-trusted-certificate-package"></a>Install the trusted certificate package
...
### <a name="configure-the-device-health-attestation-service"></a>Configure the Device Health Attestation service
...
### <a name="configure-the-certificate-chain-policy"></a>Configure the certificate chain policy
...
## <a name="dha-management-commands"></a>DHA management commands

Here are some Windows PowerShell examples that can help you manage the DHA service.

### <a name="configure-the-dha-service-for-the-first-time"></a>Configure the DHA service for the first time
...
### <a name="remove-the-dha-service-configuration"></a>Remove the DHA service configuration

```
Uninstall-DeviceHealthAttestation -RemoveSslBinding -Force
```
### <a name="get-the-active-signing-certificate"></a>Get the active signing certificate

```
Get-DHASActiveSigningCertificate
```
### <a name="set-the-active-signing-certificate"></a>Set the active signing certificate
...
### <a name="list-the-inactive-signing-certificates"></a>List the inactive signing certificates
```
Get-DHASInactiveSigningCertificates
```

### <a name="remove-any-inactive-signing-certificates"></a>Remove any inactive signing certificates
```
...
### <a name="get-the-active-encryption-certificate"></a>Get the active encryption certificate

```
Get-DHASActiveEncryptionCertificate
```

### <a name="set-the-active-encryption-certificate"></a>Set the active encryption certificate
...
### <a name="list-the-inactive-encryption-certificates"></a>List the inactive encryption certificates

```
Get-DHASInactiveEncryptionCertificates
```
### <a name="remove-any-inactive-encryption-certificates"></a>Remove any inactive encryption certificates
...
### <a name="get-the-x509chainpolicy-configuration"></a>Get the X509ChainPolicy configuration 

```
Get-DHASCertificateChainPolicy
```
### <a name="change-the-x509chainpolicy-configuration"></a>Change the X509ChainPolicy configuration
...
## <a name="dha-service-reporting"></a>DHA service reporting
