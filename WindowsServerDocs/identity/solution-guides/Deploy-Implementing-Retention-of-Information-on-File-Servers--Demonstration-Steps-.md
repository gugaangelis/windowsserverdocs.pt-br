...
## <a name="step-1-create-resource-property-definitions"></a><a name="BKMK_Step1"></a>Etapa 1: criar definições de propriedade de recurso  
...
#### <a name="to-configure-notifications"></a>Para configurar as notificações  
