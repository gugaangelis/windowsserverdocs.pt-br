...
## <a name="step-3-use-file-management-tasks-to-automatically-protect-documents-with-ad-rms"></a><a name="BKMK_3"></a>Etapa 3: usar as tarefas de gerenciamento de arquivos para proteger automaticamente os documentos com o AD RMS  
...
## <a name="step-4-view-the-results"></a><a name="BKMK_4"></a>Etapa 4: exibir os resultados  
...
## <a name="step-5-verify-protection-with-ad-rms"></a><a name="BKMK_5"></a>Etapa 5: verificar a proteção com AD RMS  
