...
Você precisa configurar o seguinte para o laboratório. Esses procedimentos são explicados em detalhes em [apêndice b: Configurando o ambiente de teste](Appendix-B--Setting-Up-the-Test-Environment.md)  
...
1.  Entrar no controlador de domínio, contoso.com como administrador com a senha **pass@word1**.  
