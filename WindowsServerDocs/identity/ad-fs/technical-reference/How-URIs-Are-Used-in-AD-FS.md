...
|------------------------------------------------------------|-----------------------------------------------|------------------------------------------------------------|----------|  
|http: \/ \/ contoso.com|http: \/ \/ contoso.com|VERDADEIRO|Correspondência exata|  
|http: \/ \/ contoso.com\/|http: \/ \/ contoso.com|VERDADEIRO|Barras à direita são ignoradas|  
|http: \/ \/ contoso.com|http: \/ \/ contoso.com\/|VERDADEIRO|Barras à direita são ignoradas|  
|http: \/ \/ contoso.com|http: \/ \/ contoso.com \/ hr|VERDADEIRO|O URI1 não tem caminho e combina esquema e autoridade com URI2|  
|http: \/ \/ contoso.com \/ hr|http: \/ \/ contoso.com \/ HR \/ Web|VERDADEIRO|As primeiras seções do caminho são correspondentes, URI1 não tem nenhuma segunda seção do caminho|  
|http: \/ \/ contoso.com \/ hr\/|http: \/ \/ contoso.com \/ HRW \/ Main|FALSO|A seção 1 do caminho do URI1 não coincide com a seção do caminho de URI2 1|  
|http: \/ \/ contoso.com \/ hr|http: \/ \/ contoso.com|FALSO|URI1 tem mais seções de caminho que URI2|  
|http: \/ \/ contoso.com \/ hr|http: \/ \/ contoso.com \/ hrweb|FALSO|As primeiras seções do caminho não coincidem|  
|https: \/ \/ contoso.com|http: \/ \/ contoso.com|FALSO|Partes do esquema não coincidem|  
|http: \/ \/ STS.contoso.com|http: \/ \/ contoso.com|FALSO|As partes de autoridade não coincidem|  
|http: \/ \/ contoso.com|http: \/ \/ STS.contoso.com|FALSO|As partes de autoridade não coincidem|  
