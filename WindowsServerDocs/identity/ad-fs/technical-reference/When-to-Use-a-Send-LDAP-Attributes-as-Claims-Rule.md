...
Você pode criar essa regra usando o idioma da regra de declaração ou usando o modelo enviar atributos LDAP como regra de declarações no snap\--in de gerenciamento de AD FS. Esse modelo de regra fornece as seguintes opções de configuração:  
