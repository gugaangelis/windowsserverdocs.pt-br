...
ms.locfileid: "66192527"
---
# <a name="ad-fs-operations"></a>Operações do AD FS



Este documento contém uma lista de todas as operações de documentação do AD FS para Windows Server 2016. Isso inclui o seguinte:  
...
- [Configurações de logon único do AD FS 2016](../ad-fs/operations/AD-FS-2016-Single-Sign-On-Settings.md)
...
- [Adicionar um atributo Store](../ad-fs/operations/Add-an-Attribute-Store.md)
- [Autenticação composta e declarações do AD DS no AD FS](../ad-fs/operations/AD-FS-Compound-Authentication-and-AD-DS-claims.md)
- [Configurar o AD FS 2016 e o MFA do Azure](../ad-fs/operations/Configure-AD-FS-2016-and-Azure-MFA.md)
...
- [Configurar o AD FS para autenticação de certificado de usuário](../ad-fs/operations/Configure-User-Certificate-Authentication.md)
...
- [Personalizar cabeçalhos de resposta de segurança HTTP com o AD FS de 2019](../ad-fs/operations/customize-http-security-headers-ad-fs.md)
...
- [Como gerenciar certificados SSL no AD FS e no WAP 2016](../ad-fs/operations/Manage-SSL-Certificates-AD-FS-WAP-2016.md)
