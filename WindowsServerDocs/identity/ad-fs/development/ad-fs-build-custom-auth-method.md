...
1. Ainda não estamos prontos para compilar... Há mais duas interfaces a serem acessadas.
...
2. Em seguida, você pode adicionar os membros necessários para cada um. Primeiro, os metadados (com comentários embutidos úteis)
...
3.  Observe o ' todo ' para o elemento **Resources. FormPageHtml** acima.
