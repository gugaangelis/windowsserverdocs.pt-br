...
Em situações em que você está usando Serviços de Federação do Active Directory (AD FS) \(AD FS @ no__t-1 para emitir declarações que serão recebidas por servidores de Federação que executam AD FS 1,0 \(Windows Server 2003 R2 @ no__t-3 ou AD FS 1,1 \(Windows Server 2008 ou Windows Server 2008 R2 @ no__t-5, você deve fazer o seguinte:  
...
8.  Em **formato de ID de nome de entrada**, selecione uma das seguintes AD FS 1. os formatos de Declaração *x*@no__t 2compatible da lista:  
...
9. Em **formato de ID de nome de saída**, selecione uma das seguintes AD FS 1. os formatos de Declaração *x*@no__t 2compatible da lista:  
