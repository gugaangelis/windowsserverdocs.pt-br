...
ESL só está disponível para o nome de usuário e solicitações de autenticação de senha que são fornecidas por meio da extranet com Proxy de aplicativo Web ou um dia 3 de proxy de terceiros. Qualquer proxy de terceiros 3ª deve dar suporte o protocolo MS-ADFSPIP a ser usado no lugar de Proxy de aplicativo Web, como [F5 BIG-IP Access Policy Manager](https://devcentral.f5.com/s/articles/ad-fs-proxy-replacement-on-f5-big-ip-30191). Consulte a documentação de proxy de terceiros 3ª para determinar se o proxy é compatível com o protocolo MS-ADFSPIP.   
...
**ESL funciona na intranet muito?**   
R: Se os clientes se conectarem diretamente aos servidores do AD FS e não por meio de servidores de Proxy de aplicativo Web, em seguida, o comportamento de ESL não se aplicará. 
