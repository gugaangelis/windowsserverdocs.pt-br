...
-   [Guia passo a passo: Gerenciar o risco com controle de acesso condicional](Walkthrough-Guide--Manage-Risk-with-Conditional-Access-Control.md)  
  
-   [Guia passo a passo: Gerenciar o risco com autenticação multifator adicional para aplicativos confidenciais](Walkthrough-Guide--Manage-Risk-with-Additional-Multi-Factor-Authentication-for-Sensitive-Applications.md)  
...
1.  > [!IMPORTANT]  
    ...
    Quando você for solicitado para uma conta de serviço, digite **contosofsgmsa$**.  
...
2.  [Instalar o Windows Identity Foundation SDK](../../ad-fs/deployment/Set-up-the-lab-environment-for-AD-FS-in-Windows-Server-2012-R2.md#BKMK_13)  
...
10. Sobre o **confirmar seleções de instalação** página, clique em **especificar um caminho de origem alternativo**. Insira o caminho para o diretório Sxs que está localizado na mídia de instalação do Windows Server 2012 R2. Por exemplo, D:SourcesSxs. Clique em **Okey**e clique em **instalar**.  
...
2.  Copie o conteúdo do c:de arquivos (x86) Windows Identity Foundation SDKv3.5SamplesQuick StartWeb ApplicationPassiveRedirectBasedClaimsAwareWebApp para C:InetpubClaimapp.  
...
4.  **Configurar o Gerenciador do IIS**  
    ...
    7.  Defina o alias como **claimapp** e o caminho físico para **c:inetpubclaimapp**.  
  
5.  Para configurar **claimapp** para trabalhar com o servidor de federação, faça o seguinte:  
  
    1.  Execute FedUtil.exe, que está localizado na **c:de arquivos (x86) Windows Identity Foundation SDKv3.5**.  
  
    2.  Defina o local de configuração do aplicativo para **C:inetputclaimappweb.config** e defina o URI do aplicativo para a URL para o seu site, **https://webserv1.contoso.com /claimapp/**. Clique em **próxima**.  
...
2.  No **Selecionar fonte de dados** , selecione **importar dados sobre o terceiro publicados online ou em uma rede local**, insira a URL de metadados para **claimapp**e clique em **próxima**. Executar FedUtil.exe criado um arquivo. XML de metadados. Ele está localizado em   
