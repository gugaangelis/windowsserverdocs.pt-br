...
Para obter mais informações sobre a lógica e asa opções dessas regras, consulte [Quando usar uma regra de autorização de declaração](https://technet.microsoft.com/library/ee913560.aspx).
...
|{1&gt;Nome&lt;1}|O nome exclusivo do usuário.|
...
|Cliente IP|O endereço IP do cliente.|
...
|Nome da Entidade|O nome diferenciado do assunto de um certificado.|
...
## <a name="managing-risk-with-conditional-access-control"></a><a name="BKMK_2"></a>Gerenciando riscos com o controle de acesso condicional
