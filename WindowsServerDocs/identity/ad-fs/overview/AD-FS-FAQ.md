...
- No caso de uma relação de confiança de floresta unidirecional, como uma floresta de DMZ que contém identidades de parceiros, é recomendável implantar o AD FS na floresta corp e tratar a floresta da rede de Perímetro como outro confiança do provedor de declarações local conectada por meio do LDAP. No caso de você não é possível adotar essa opção, você precisa executar o AD FS na floresta "confiante" usando uma conta de serviço na "floresta confiável" que tem acesso completo aos usuários na floresta "confiante".
...
[Gerenciar certificados SSL em AD FS e WAP 2016](../operations/Manage-SSL-Certificates-AD-FS-WAP-2016.md)
