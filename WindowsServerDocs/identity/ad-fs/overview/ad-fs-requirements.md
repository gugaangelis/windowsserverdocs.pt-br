...
Esse certificado não é necessário para a maioria dos cenários do AD FS incluindo o Azure AD e o Office 365.
Por padrão, o AD FS configura o certificado SSL fornecido na configuração inicial como o certificado de comunicação de serviço.
