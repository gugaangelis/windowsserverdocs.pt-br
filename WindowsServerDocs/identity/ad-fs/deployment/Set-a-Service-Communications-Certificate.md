...
ms.locfileid: "59888467"
---
# <a name="set-a-service-communications-certificate"></a>Definir um certificado de comunicações de serviço

>Aplica-se a: Windows Server 2016, Windows Server 2012 R2, Windows Server 2012

Servidores de federação nos serviços de Federação do Active Directory \(do AD FS\) usar o certificado de comunicações de serviço para proteger o tráfego de serviços da Web para Secure Sockets Layer \(SSL\) comunicação com a Web os clientes ou com proxies do servidor de Federação. Esse é o mesmo certificado que um servidor de federação usa como certificado de SSL no Internet Information Services \(IIS\).  
