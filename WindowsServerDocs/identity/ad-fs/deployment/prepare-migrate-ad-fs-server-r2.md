...
## <a name="next-steps"></a>Próximas etapas
 [Migrar serviços de Federação do Active Directory (AD FS) serviços de função para o Windows Server 2012 R2](migrate-ad-fs-service-role-to-windows-server-r2.md) [migrando o servidor de Federação AD FS](migrate-ad-fs-fed-server-r2.md) [migrando o Proxy de servidor de federação AD FS](migrate-fed-server-proxy-r2.md) [verificando a AD FS migração para o Windows Server 2012 R2](verify-ad-fs-migration.md)
