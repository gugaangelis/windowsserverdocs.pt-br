...
Você adiciona um computador a um farm com o assistente de configuração do servidor de Federação AD FS. Quando você usa esse assistente para ingressar um computador em um farm existente, o computador é configurado com uma cópia somente leitura\-do banco de dados de configuração do AD FS e deve receber atualizações de um servidor de Federação primário.  
