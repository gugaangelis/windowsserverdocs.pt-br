                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Descubra quais são as novidades nos Serviços de Federação do Active Directory (AD FS)</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Documentação detalhada sobre todos os recursos disponíveis para o AD DS no Windows Server.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Serviços de Federação do Active Directory</h3><hr />
                        <p>Documentação detalhada sobre todos os recursos disponíveis para o AD FS no Windows Server.</p>
                    </div>
                </div>
            </div>
        </div>
