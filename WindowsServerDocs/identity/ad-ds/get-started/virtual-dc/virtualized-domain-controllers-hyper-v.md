...
Além disso, não planeje usar um VHD de disco diferente em uma máquina virtual configurada como um controlador de domínio porque ele pode reduzir o desempenho. Para saber mais sobre os tipos de disco do Hyper-V, incluindo discos diferenciais, confira [Assistente de novo disco rígido virtual](http://go.microsoft.com/fwlink/?linkid=137279).
