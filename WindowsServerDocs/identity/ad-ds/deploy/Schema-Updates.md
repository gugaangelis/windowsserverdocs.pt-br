...
title: Atualizações de esquema no Windows Server
description: Alterações de esquema feitas pela adprep pela versão do sistema operacional
...
ms.locfileid: "71369611"
---
# <a name="windows-server-active-directory-schema-updates"></a>Atualizações de esquema do Windows Server Active Directory

>Aplica-se a: Windows Server

Este tópico lista os arquivos LDF que incluem as alterações que o Adprep. exe faz.  

Este é o arquivo LDF incluído no Windows Server 2019:

-   [Sch88. ldf](#BKMK_Sch88)

Estes são os arquivos LDF incluídos no Windows Server 2016:
...
Estes são os arquivos LDF incluídos no Windows Server 2012 R2:  
...
Estes são os arquivos LDF incluídos no Windows Server 2012:  
...
## <a name="schema-update-in-windows-server-2019"></a>Atualização de esquema no Windows Server 2019
...
## <a name="schema-updates-in-windows-server-2016"></a>Atualizações de esquema no Windows Server 2016
...
## <a name="BKMK_SchemaUpdates2012R2"></a>Atualizações de esquema no Windows Server 2012 R2  
...
## <a name="BKMK_SchemaUpdates2012"></a>Atualizações de esquema no Windows Server 2012  
