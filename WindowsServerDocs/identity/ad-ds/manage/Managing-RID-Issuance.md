...
### <a name="rid-block-size-limit"></a><a name="BKMK_RIDBlockMaxSize"></a>Limite de tamanho de bloco de RID  
...
### <a name="global-rid-space-size-unlock"></a><a name="BKMK_GlobalRidSpaceUnlock"></a>Desbloqueio de tamanho de espaço global do RID  
...
## <a name="troubleshooting-rid-issuance"></a><a name="BKMK_Tshoot"></a>Solucionando problemas de emissão de RID  
