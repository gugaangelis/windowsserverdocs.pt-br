...
## <a name="bkmk_2_1_Plan_LB"></a>balanceamento de carga do plano 3,1  
...
### <a name="ELBConfigEx"></a>exemplo de configuração de Load Balancer externa 3.1.1  
...
## <a name="bkmk_2_2_NLB"></a>IP do plano 3,2-HTTPS  
...
## <a name="BKMK_3.3"></a>3,3 plano para conexões de cliente VPN  
...
## <a name="BKMK_nls"></a>3,4 planejar o servidor do local de rede  
