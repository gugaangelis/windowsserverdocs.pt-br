...
ms.locfileid: "71404893"
---
# <a name="install-and-configure-basic-directaccess"></a>Instalação e configuração básicas do DirectAccess

>Aplicável ao: Windows Server (canal semestral), Windows Server 2016

Esta visão geral fornece uma introdução às etapas de configuração necessárias para implantar um único servidor DirectAccess executando as configurações do Windows Server 2016, do Windows Server 2012 R2 ou do Windows Server 2012with Basic.  
