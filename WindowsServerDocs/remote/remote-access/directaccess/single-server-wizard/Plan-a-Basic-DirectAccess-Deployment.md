...
1.  [Etapa 1: Planeje a infraestrutura básica do DirectAccess @ no__t-0-planejar a topologia de rede e de servidor, configurações de firewall, requisitos de certificado, DNS e Active Directory.  
  
2.  [Etapa 2: Planeje a implantação básica do DirectAccess @ no__t-0-planejar implantação de cliente e servidor.  
