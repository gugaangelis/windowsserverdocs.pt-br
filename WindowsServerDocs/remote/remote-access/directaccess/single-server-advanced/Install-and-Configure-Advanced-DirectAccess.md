...
ms.locfileid: "59847017"
---
# <a name="install-and-configure-advanced-directaccess"></a>Instalar e configurar o DirectAccess avançado

>Aplica-se a: Windows Server (canal semestral), Windows Server 2016

Esta visão geral lista as etapas de configuração necessárias para implantar um único servidor DirectAccess executando o Windows Server 2016, Windows Server 2012 R2 ou Windows Server 2012 com IPv4 e IPv6.  
  
-   [Etapa 1: Configurar a infraestrutura de DirectAccess avançada](da-adv-configure-s1-infrastructure.md).  
...
-   [Etapa 3: Verifique se a implantação avançada do DirectAccess](da-adv-configure-s3-verify.md).  
