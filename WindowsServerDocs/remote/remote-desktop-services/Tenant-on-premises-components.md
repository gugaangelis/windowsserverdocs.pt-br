...
[Novidades no Gateway de Área de Trabalho Remota do Windows Server 2012 R2](https://techcommunity.microsoft.com/t5/microsoft-security-and/what-8217-s-new-in-windows-server-2012-remote-desktop-gateway/ba-p/247611)  
[Clientes de Área de Trabalho Remota da Microsoft](./clients/remote-desktop-clients.md)  
...
Informações adicionais:  
[Visão geral da rede virtual do Microsoft Azure](/azure/virtual-network/virtual-networks-overview)  
