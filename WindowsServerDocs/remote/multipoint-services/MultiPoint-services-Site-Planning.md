...
![Várias conexões com zero cliente USB](./media/WMS_diagram4.gif "WMS_diagram4")
...
![Configuração do laboratório de informática](./media/WMS_ComputerLabLayout.gif)
