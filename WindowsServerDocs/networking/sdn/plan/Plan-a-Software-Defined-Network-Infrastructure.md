...
>[!IMPORTANT]
>A rede de software definida pelo Windows Server 2016 dá suporte ao endereçamento IPv4 para o underlay e a sobreposição. IPv6 sem suporte.
...
|   **Rede lógica VIP GRE**   |                                                                                                                                           A rede VIP GRE é uma sub-rede que existe exclusivamente para definir VIPs atribuídos a máquinas virtuais de gateway em execução em sua malha SDN para um tipo de conexão GRE S2S. Essa rede não precisa ser pré-configurada em seus comutadores físicos ou roteadores e não precisa ter uma VLAN atribuída.                                                                                                                                            |
...
| **Nome da rede** |  **Redes**  | **Mascara** | **ID de VLAN no caminhão** | **Gateway**  |                                                           **Reservas (exemplos)**                                                           |
|------------------|--------------|----------|----------------------|--------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
...
|    VIP público    |  41.40.40.0  |    27    |          N/D          |  41.40.40.1  |                                    41.40.40.1 – roteador 41.40.40.2-SLB/MUX VIP 41.40.40.3-VIP VPN S2S IPSec                                    |
|   VIP privado    |  20.20.20.0  |    27    |          N/D          |  20.20.20.1  |                                                        20.20.20.1 – GW padrão (roteador)                                                         |
|     VIP GRE      |  31.30.30.0  |    24    |          N/D          |  31.30.30.1  |                                                             31.30.30.1-GW padrão                                                             |
...
| **Nome da rede** |  **Redes**  | **Mascara** | **ID de VLAN no caminhão** | **Gateway**  |                                                           **Reservas (exemplos)**                                                            |
|------------------|--------------|----------|----------------------|--------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
|     Storage1     |  10.60.36.0  |    25    |          8           |  10.60.36.1  |  10.60.36.1 – roteador<p>10.60.36. X – host de computação X<p>10.60.36. y-host de computação Y<p>10.60.36. V-cluster de computação<p>10.60.36. W-cluster de armazenamento  |
...
[Requisitos de instalação e preparação para a implantação do controlador de rede](Installation-and-Preparation-Requirements-for-Deploying-Network-Controller.md)  
