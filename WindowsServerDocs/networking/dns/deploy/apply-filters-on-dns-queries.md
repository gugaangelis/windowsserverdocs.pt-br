...
## <a name="bkmk_block1"></a>Bloquear consultas de um domínio
...
## <a name="bkmk_block2"></a>Bloquear consultas de uma sub-rede
...
## <a name="bkmk_allow2"></a>Permitir consultas somente de uma sub-rede
...
## <a name="bkmk_allow3"></a>Permitir apenas determinados QTypes
