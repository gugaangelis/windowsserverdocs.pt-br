...
**Para substituir <em>user@example.microsoft.com</em> com *example.microsoft.com\user***
...
<strong>Para substituir *usuário* com *user@specific_domain</strong>*
