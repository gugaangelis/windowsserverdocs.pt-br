...
**Para substituir <em>user@example.microsoft.com</em> por *example. Microsoft. com\user***
...
**Para substituir o *domínio \ usuário* por *specific_domain\user***
