...
description: O tópico de comandos do Windows para **Auditpol set** – define a política de auditoria por usuário, a política de auditoria do sistema ou as opções de auditoria.
ms.custom: na
