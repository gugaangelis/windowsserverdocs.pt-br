...
|        /u <Domain> @ no__t-1 @ no__t-2         | Executa o comando com as permissões de conta do usuário especificado pelo usuário ou Domain\User. O padrão é as permissões do usuário conectado no momento no computador que emite o comando. |
