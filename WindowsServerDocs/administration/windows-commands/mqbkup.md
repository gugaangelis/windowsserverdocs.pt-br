...
|> de <de pasta path_to_storage \_ dispositivo|Especifica o caminho onde os arquivos de mensagem MSMQ e as configurações do registro são armazenados|
