...
ms.locfileid: "83437121"
---
# <a name="erase"></a>erase

Exclui um ou mais arquivos. Esse comando executa as mesmas ações que o comando **del** .

> [!WARNING]
> Se você usar **apagar** para excluir um arquivo do disco, não poderá recuperá-lo.
