...
description: Tópico de referência para o comando de rastreamento de atualização do logman, que atualiza as propriedades de um coletor de dados de rastreamento de eventos existente.
