---
title: Logman criar rastreamento
...
ms.locfileid: "59832277"
---
# <a name="logman-create-trace"></a>Logman criar rastreamento
...
O exemplo a seguir cria um coletor de dados de rastreamento de evento chamado trace_log usando nenhum buffer menos de 16 e não mais do que 256, cada buffer de 64kb de tamanho e gera os resultados para o c:\logfile local.  
```  
