...
- Salve o backup no volume f:
  ...
  ```
  Cenário #2
- Execute um backup único de *f:\\Pasta1* e *h:\\Pasta2* para o volume *d:* .
...
- Faça um backup de cópia para que o backup diferencial normalmente agendado não seja afetado.
  ...
  ```
  Cenário #3
- Execute um backup único de *d:\\Pasta1* que deve ser submetido a backup não recursivamente.
