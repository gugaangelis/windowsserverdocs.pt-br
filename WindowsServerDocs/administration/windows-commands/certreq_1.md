...
|ValidityPeriodUnits</br>Observação: Isso é usado somente quando a solicitação de tipo = cert.|Especifica um número de unidades a ser usado com ValidityPeriod.|Numérico|ValidityPeriodUnits = 3|
