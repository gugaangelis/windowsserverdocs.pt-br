...
```
O exemplo a seguir ilustra o uso de * * * * de protetores de comando para desabilitar a proteção até que o computador foi reinicializado a 3 vezes.
```
