...
- Para nomes de adaptador, o **ipconfig** dá suporte ao uso do caractere curinga asterisco (\*) para especificar os adaptadores com nomes que começam com uma cadeia de caracteres especificada ou adaptadores com nomes que contêm uma cadeia de caracteres especificada. Por exemplo, **local @ no__t-1** corresponde a todos os adaptadores que começam com a cadeia de caracteres local e **\*Con @ no__t-4** corresponde a todos os adaptadores que contêm a cadeia de caracteres con.
