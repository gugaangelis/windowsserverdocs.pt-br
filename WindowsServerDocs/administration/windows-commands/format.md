...
|/fs:{FAT|FAT32|NTFS|UDF}|Especifica o tipo de sistema de arquivos: FAT, FAT32, NTFS ou UDF. Disquetes podem usar apenas o sistema de arquivos FAT.|
...
-   **Formato** mensagens
    ...
    Ao concluir, a formatação **formato** exibe mensagens que mostram o espaço total em disco, os espaços marcados como defeituosos e o espaço disponível para seus arquivos.
-   Formatação rápida
...
[Chave de sintaxe de linha de comando](https://technet.microsoft.com/library/cc771080.aspx)