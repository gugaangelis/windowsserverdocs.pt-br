...
|/DCOPY: \<copyflags @ no__t-1|Define o que copiar para diretórios. O padrão é DA. As opções são D = dados, A = atributos e T = carimbos de data/hora.|
...
|Opção|Descrição|
|------|-----------|
|SRDF|Copia somente os arquivos para os quais o atributo de **arquivo** está definido.|
