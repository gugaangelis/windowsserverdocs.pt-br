...
description: O tópico de comandos do Windows para Add-ImageDriverPackage, que adiciona um pacote de driver que está no repositório de drivers a uma imagem de inicialização existente no servidor.
