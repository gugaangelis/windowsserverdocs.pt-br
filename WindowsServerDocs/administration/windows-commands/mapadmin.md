---
title: mapadmin
description: Tópico de referência para o comando mapadmin, que gerencia Mapeamento de Nomes de Usuário para serviços da Microsoft para o sistema de arquivos de rede.
