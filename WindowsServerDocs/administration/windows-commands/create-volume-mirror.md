...
description: Tópico de referência para criar espelhamento de volume, que cria um espelho de volume usando os dois discos dinâmicos especificados.
...
|        alinha\=<n>         | Alinha todas as extensões de volume ao limite de alinhamento mais próximo. Esse parâmetro é normalmente usado com matrizes de LUN \(\) de número de unidade lógica RAID de hardware para melhorar o desempenho. *n* é o número de kilobytes \(KB\) desde o início do disco até o limite de alinhamento mais próximo. |
