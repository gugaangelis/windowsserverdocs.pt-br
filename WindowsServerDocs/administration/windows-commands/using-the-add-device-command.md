...
description: Tópico de referência para Add-Device, que pré-testar um computador nos serviços de domínio Active Directory. Os computadores pré-configurados também são chamados de computadores conhecidos.
...
de sintaxe de linha de comando[usando o comando](using-the-get-alldevices-command.md)
Get-meus dispositivos[usando o subcomando Get-Device comando](using-the-get-device-command.md)
