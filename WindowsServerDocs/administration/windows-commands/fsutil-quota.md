---
title: fsutil quota
description: Tópico de referência para o comando de cota fsutil, que gerencia as cotas de disco em volumes NTFS para fornecer um controle mais preciso do armazenamento baseado em rede.
