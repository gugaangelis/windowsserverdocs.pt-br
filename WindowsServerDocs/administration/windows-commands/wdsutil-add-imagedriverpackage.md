...
description: Artigo de referência para WDSUTIL Add-ImageDriverPackage, que adiciona um pacote de driver que está no repositório de driver a uma imagem de inicialização existente no servidor.
ms.topic: reference
