...
description: Tópico de referência para o comando de alerta de atualização do logman, que atualiza as propriedades de um coletor de dados de alerta existente.
