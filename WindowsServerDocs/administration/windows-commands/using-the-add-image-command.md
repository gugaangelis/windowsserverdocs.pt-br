...
description: Tópico de referência para Add-Image, que adiciona imagens a um servidor de serviços de implantação do Windows.
...
de sintaxe de linha de comando[usando o comando](using-the-copy-image-command.md)
Copy-Image usando o
[comando Export-Image](using-the-export-image-command.md)
