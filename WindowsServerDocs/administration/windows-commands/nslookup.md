...
|Parâmetro|Descrição|
|-------|--------|
|[Comando de saída de nslookup](nslookup-exit-command.md)|Sai **nslookup**.|
|[nslookup dedo comando](nslookup-finger-command.md)|Conecta-se com o servidor de dedo no computador atual.|
|[Ajuda de nslookup](nslookup-help.md)|Exibe um resumo breve dos **nslookup** subcomandos.|
|[ls nslookup](nslookup-ls.md)|lista informações de um domínio DNS.|
|[nslookup lserver](nslookup-lserver.md)|Altera o servidor padrão para o domínio DNS especificado.|
|[raiz de nslookup](nslookup-root.md)|Altera o servidor padrão para o servidor para a raiz do espaço de nome de domínio DNS.|
...
|[Definir tudo de nslookup](nslookup-set-all.md)|Imprime os valores atuais das definições de configuração.|
|[classe set de nslookup](nslookup-set-class.md)|Altera a classe da consulta. A classe especifica o grupo de protocolo das informações.|
...
|[Configure o Nslookup debug](nslookup-set-debug.md)|Ativa ou desativa o modo de depuração.|
...
|[domínio do conjunto de nslookup](nslookup-set-domain.md)|Altera o nome de domínio DNS padrão para o nome especificado.|
|Ignorar /set nslookup|Ignora erros de truncamento de pacote.|
|[nslookup definir porta](nslookup-set-port.md)|Altera a porta do servidor de nome DNS de TCP/UDP para o valor especificado.|
|[nslookup conjunto querytype](nslookup-set-querytype.md)|Altera o tipo de registro de recurso para a consulta.|
|[nslookup conjunto recurse](nslookup-set-recurse.md)|Informa ao servidor de nome DNS para consultar outros servidores se não tiver as informações.|
|[repetição de conjunto de nslookup](nslookup-set-retry.md)|Define o número de repetições.|
|[raiz do conjunto de nslookup](nslookup-set-root.md)|Altera o nome do servidor raiz usado para consultas.|
...
|[Definir tempo limite de nslookup](nslookup-set-timeout.md)|Altera o número inicial de segundos a aguardar uma resposta a uma solicitação.|
|[tipo de conjunto de nslookup](nslookup-set-type.md)|Altera o tipo de registro de recurso para a consulta.|
|[nslookup set vc](nslookup-set-vc.md)|Especifica se deve ou não usar um circuito virtual ao enviar solicitações ao servidor.|
|[modo de exibição de nslookup](nslookup-view.md)|classifica e lista a saída de versões anteriores **ls** subcomando ou comandos.|
