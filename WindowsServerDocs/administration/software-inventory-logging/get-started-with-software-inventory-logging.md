...
[Software Inventory Logging Cmdlets in Windows PowerShell (Cmdlets de Log de Inventário de Software no Windows PowerShell)](https://technet.microsoft.com/library/dn283390.aspx)<br>
