...
## [Apresentando o Windows Server, versão 1809](get-started-with-1803.md)
## [Novidades do Windows Server](whats-new-in-windows-server.md)
...
## [Opções de upgrade e conversão para o Windows Server 2016](Supported-Upgrade-paths.md)
...
## Recursos removidos ou planejados para remoção nas versões do Windows Server
...
## [Benefício Híbrido do Azure para Windows Server](azure-hybrid-benefit.md)
## [Guia de ativação do Windows Server 2016](Server-2016-activation.md)
### [Chaves de Instalação de Cliente KMS](KMSclientkeys.md)
### [Solução de problemas de códigos de erro de ativação](activation-error-codes.md)
...
#### [IIS do Nano Server](IIS-on-Nano-Server.md)
#### [MPIO do Nano Server](MPIO-on-Nano-Server.md)
