...
ms.locfileid: "59841237"
---
# <a name="windows-server-semi-annual-channel-overview"></a>Visão geral do canal semestral do Windows Server
...
**Há dois canais de lançamento principal disponível para clientes do Windows Server, o canal de manutenção em longo prazo e o canal semestral.** Você pode manter os servidores no canal de serviço de Longo prazo (LTSC), transferi-los para o canal semestral ou ter alguns servidores em qualquer faixa, dependendo de qual funciona melhor para suas necessidades.
...
## <a name="obtain-preview-releases-through-the-windows-insider-program"></a>Obter versões prévias por meio do Programa Windows Insider
...
[Servidor de Windows 2019 canais de manutenção: LTSC e SAC](https://docs.microsoft.com/windows-server/get-started-19/servicing-channels-19)

[Alterações no Nano Server no canal semestral do Windows Server](nano-in-semi-annual-channel.md)

[Ciclo de vida de suporte do Windows Server](https://support.microsoft.com/en-us/lifecycle)
