...
- [O Agendador clássico de compartilhamento justo](#the-classic-scheduler)
- [O Agendador principal](#the-core-scheduler)
- [O Agendador raiz](#the-root-scheduler)
...
Quando o VP está agendado para uma máquina virtual sem SMT habilitado, esse VP consumirá todo o núcleo quando for executado.
...
O Agendador principal será usado por padrão a partir do Windows Server 2019. No Windows Server 2016, o Agendador principal é opcional e deve ser explicitamente habilitado pelo administrador do host Hyper-V e o Agendador clássico é o padrão.
...
A partir do Windows 10 versão 1803, o Agendador raiz é usado por padrão somente em sistemas cliente, em que o hipervisor pode ser habilitado para dar suporte a segurança baseada em virtualização e isolamento de carga de trabalho WDAG e para a operação adequada de sistemas futuros com arquiteturas de núcleos heterogêneos. Essa é a única configuração do Agendador de hipervisor com suporte para sistemas cliente. Os administradores não devem tentar substituir o tipo de Agendador de hipervisor padrão em sistemas de cliente do Windows 10.
