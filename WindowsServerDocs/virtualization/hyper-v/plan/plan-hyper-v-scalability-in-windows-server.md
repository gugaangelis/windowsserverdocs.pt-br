...
|Componente|Máximo|{1&gt;Observações&lt;1}|  
|-------------|-----------|---------|  
...
|Dispositivos de disquete virtuais|1 unidade de disquete|None.|
...
|Adaptadores de rede físicos|Nenhum limite imposto pelo Hyper-V.|None.|  
|Máquinas virtuais em execução por servidor|1024|None.|  
...
|Processadores virtuais por processador lógico|Nenhuma razão imposta pelo Hyper-V.|None.|  
|Processadores virtuais por servidor|2048|None.|  
|Redes SAN (redes de área de armazenamento) virtuais|Nenhum limite imposto pelo Hyper-V.|None.|  
