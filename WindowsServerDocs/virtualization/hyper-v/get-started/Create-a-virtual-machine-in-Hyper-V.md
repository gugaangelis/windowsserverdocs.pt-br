...
|--------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|  
|**Especificar o nome e o local**|Nome:  Nova máquina virtual.<br /><br />Local:  **C:\ProgramData\Microsoft\Windows\Hyper-V @ no__t-1**.|Você também pode inserir seu próprio nome e escolher outro local para a máquina virtual.<br /><br />É aí que os arquivos de configuração da máquina virtual serão armazenados.|  
...
|**Conectar o disco rígido virtual**|Criar um disco rígido virtual<br /><br />Nome: <*vmname*>. vhdx<br /><br />**Local**: **C:\Users\Public\Documents\Hyper-V\Virtual discos rígidos @ no__t-1**<br /><br />**Tamanho**: 127 GB|Você também pode optar por usar um disco rígido virtual existente ou aguardar e anexar um disco rígido virtual mais tarde.|  
