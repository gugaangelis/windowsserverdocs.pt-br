...
### <a name="nested-virtualization-new"></a>A virtualização aninhada \(novo\)
...
### <a name="rolling-hyper-v-cluster-upgrade-new"></a>Atualização do Cluster Hyper-V sem interrupção \(novo\)
