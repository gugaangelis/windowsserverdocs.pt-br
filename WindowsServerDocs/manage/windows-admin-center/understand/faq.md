...
O Windows Admin Center é otimizado para o Windows Server 2019 para permitir o uso dos temas principais na versão do Windows Server 2019: cenários de nuvem híbrida e gerenciamento da infraestrutura hiperconvergente em particular. Embora o centro de administração do Windows funcione melhor com o Windows Server 2019, ele dá suporte ao gerenciamento de uma variedade de versões que os clientes já usam: o Windows Server 2012 e mais recente são totalmente suportados. Também há uma funcionalidade limitada para gerenciar o Windows Server 2008 R2.
...
O Windows Admin Center tem um SDK disponível para que qualquer pessoa possa escrever sua própria extensão. Como uma plataforma, nossa prioridade foi a ampliação do ecossistema e permitir a extensibilidade de parceiro. [Leia mais sobre o SDK do Windows Admin Center](../extend/extensibility-overview.md).
