...
description: Instalar o Windows Admin Center
...
Examine os [opções de instalação](..\plan\installation-options.md) que inclui o [sistemas operacionais com suporte](..\plan\installation-options.md#supported-operating-systems-installation).
...
> [!NOTE]
> A modificação de TrustedHosts é necessária em um ambiente de grupo de trabalho ou quando são usadas credenciais de administrador local em um domínio. Caso opte por ignorar essa configuração, você deve [configurar o TrustedHosts manualmente](../use/troubleshooting.md#configure-trustedhosts).
...
> [!NOTE]
> A modificação de TrustedHosts é necessária em um ambiente de grupo de trabalho ou quando são usadas credenciais de administrador local em um domínio. Caso opte por ignorar essa configuração, você deve [configurar TrustedHosts manualmente](../use/troubleshooting.md#configure-trustedhosts).
