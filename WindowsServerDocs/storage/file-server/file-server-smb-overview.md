...
| Suporte nativo para chamadas à API FileNormalizedNameInformation | Novo | Adiciona suporte nativo para consultar o nome normalizado de um arquivo. Para obter detalhes, confira [FileNormalizedNameInformation](/openspecs/windows_protocols/ms-fscc/20bcadba-808c-4880-b757-4af93e41edf6). |

Para obter detalhes adicionais, confira a postagem no blog [Novidades no SMB 3.1.1 do Windows Server 2016 Technical Preview 2](/archive/blogs/josebda/whats-new-in-smb-3-1-1-in-the-windows-server-2016-technical-preview-2).
