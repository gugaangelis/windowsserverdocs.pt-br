...
| ------------------- | ------------------ | ----------------- |  
| Serviço de função Pastas de Trabalho no Gerenciador do Servidor | Windows Server 2012 R2, Windows Server 2016 ou Windows Server de 2019 | Os Serviços de Arquivo e Armazenamento oferece uma maneira de configurar compartilhamentos de sincronização (pastas que armazenam arquivos de trabalho do usuário), monitora Pastas de Trabalho e gerencia compartilhamentos de sincronização e o acesso de usuários |
| Cmdlets de Pastas de Trabalho | Windows Server 2012 R2, Windows Server 2016 ou Windows Server de 2019 | Um módulo do Windows PowerShell que contém cmdlets abrangentes para gerenciar servidores de Pastas de Trabalho |  
...
-   Um servidor executando o Windows Server 2019, Windows Server 2016 ou Windows Server 2012 R2 para hospedar sincronização compartilha com arquivos de usuário  
...
-   (Opcional) Uma floresta do Active Directory Domain Services com as extensões de esquema no Windows Server 2012 R2 para dar suporte a automaticamente aos computadores e dispositivos para o servidor de arquivo correto ao usar vários servidores de arquivos.  
