...
3.  Na página **Digite seu endereço de email de trabalho**, insira o endereço de email do usuário (por exemplo, user@contoso.com) ou a URL de Pastas de Trabalho (no exemplo de teste, https://workfolders.contoso.com) e, em seguida, clique em **Avançar**.  
