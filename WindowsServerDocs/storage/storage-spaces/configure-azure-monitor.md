...
1. No portal do Azure, clique em **Todos os serviços**. Na lista de recursos, digite **Log Analytics**. À medida que você começa a digitar, a lista filtra com base em sua entrada. Selecione **Log Analytics**.
