...
### [Configurações avançadas de Eliminação de Duplicação de Dados](data-deduplication/advanced-settings.md)
### [Interoperabilidade de Eliminação de Duplicação de Dados](data-deduplication/interop.md)
## [Namespaces DFS](dfs-namespaces/dfs-overview.md)
### [Lista de verificação: implantar namespaces DFS](dfs-namespaces/checklist-deploy-dfs-namespaces.md)
### [Lista de verificação: Ajustar um Namespace DFS](dfs-namespaces/checklist-tune-a-dfs-namespace.md)
### [Implantando namespaces DFS](dfs-namespaces/deploying-dfs-namespaces.md)
#### [Escolha um tipo de namespace](dfs-namespaces/choose-a-namespace-type.md)
#### [Crie um namespace DFS](dfs-namespaces/create-a-dfs-namespace.md)
#### [Migre um namespace baseado em domínio para modo Windows 2008 Server](dfs-namespaces/migrate-a-domain-based-namespace-to-windows-server-2008-mode.md)
#### [Adicionar servidores de namespace para um namespace DFS baseado em domínio](dfs-namespaces/add-namespace-servers-to-a-domain-based-DFS-namespace.md)
#### [Criar uma pasta em um namespace DFS](dfs-namespaces/create-a-folder-in-a-dfs-namespace.md)
#### [Adicionar pasta de destino](dfs-namespaces/add-folder-targets.md)
#### [Replicar destinos de pasta usando replicação DFS](dfs-namespaces/replicate-folder-targets-using-dfs-replication.md)
#### [Delegar permissões de gerenciamento para Namespaces DFS](dfs-namespaces/delegate-management-permissions-for-dfs-namespaces.md)
### [Ajustando namespaces de DFS](dfs-namespaces/tuning-dfs-namespaces.md)
...
#### [Mudar o tempo que os clientes armazenam as referências](dfs-namespaces/change-the-amount-of-time-that-clients-cache-referrals.md)
#### [Defina o método de ordenação dos destinos nas referências](dfs-namespaces/set-the-ordering-method-for-targets-in-referrals.md)
#### [Definir prioridade alvo para sobrepor ordem de referência](dfs-namespaces/set-target-priority-to-override-referral-ordering.md)
#### [Otimizar sondagem de namespace](dfs-namespaces/optimize-namespace-polling.md)
...
#### [Como usar permissões herdadas com enumeração baseada em acesso](dfs-namespaces/using-inherited-permissions-with-access-based-enumeration.md)
...
### [Usar o robocopy para propagar arquivos para replicação DFS](dfs-replication/preseed-dfsr-with-robocopy.md)
...
### [SMB: portas de compartilhamento de arquivo e impressora devem ser abertas](file-server/best-practices-analyzer/smb-open-file-sharing-ports.md)
### [Visão geral de sistema de arquivos de rede](nfs/nfs-overview.md)
### [Implantar o sistema de arquivos de rede](nfs/deploy-nfs.md)
### [Visão geral do NTFS](file-server/ntfs-overview.md)
### [Serviço de cópia de sombra de volume](file-server/volume-shadow-copy-service.md)
...
### [Definindo Opções do Gerenciador de Recursos de Servidor de Arquivos](fsrm/setting-file-server-resource-manager-options.md)
...
#### [Agende um conjunto de relatórios](fsrm/schedule-set-of-reports.md)
...
### [Gerenciamento de recursos de armazenamento remoto](fsrm/managing-remote-storage-resources.md)
...
## [Redirecionamento de pasta e perfis de usuário móvel](folder-redirection/folder-redirection-rup-overview.md)
### [Implantar perfis de usuário móvel](folder-redirection/deploy-roaming-user-profiles.md)
...
### [Habilitar a pasta otimizada movendo](folder-redirection/enable-optimized-moving.md)
...
### [Réplica de armazenamento de cluster para Cluster cruzar região no Azure](storage-replica/cluster-to-cluster-azure-cross-region.md)
### [Réplica de armazenamento de cluster para Cluster dentro da região de mesma no Azure](storage-replica/cluster-to-cluster-azure-one-region.md)
...
#### [Usar o CSV na memória cache de leitura](storage-spaces/csv-cache.md)
#### [Escolha de unidades](storage-spaces/choosing-drives.md)
#### [Planejamento de volumes](storage-spaces/plan-volumes.md)
#### [Clusters de convidado VM](storage-spaces/storage-spaces-direct-in-vm.md)
...
#### [Atualizar um cluster de espaços de armazenamento diretos para o Windows Server 2019](storage-spaces/upgrade-storage-spaces-direct-to-windows-server-2019.md)
### Gerencie
#### [Gerenciar com o Windows Admin Center](../manage/windows-admin-center/use/manage-hyper-converged.md)
...
### [Projetando uma implementação de Pastas de Trabalho](work-folders/plan-work-folders.md)
### [Implantando Pastas de Trabalho](work-folders/deploy-work-folders.md)
### [Implantando Pastas de Trabalho com o AD FS e o WAP (Proxy de aplicativo da Web)](work-folders/deploy-work-folders-adfs-overview.md)
...
## [Gerenciamento de integridade de memória de classe de armazenamento](storage-spaces/Storage-class-memory-health.md)
