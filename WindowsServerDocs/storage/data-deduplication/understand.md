...
| Termo | Definição |
|------|------------|
| <a id="dedup-term-chunk"></a>Parte | Uma parte é uma seção de um arquivo que foi selecionada pelo algoritmo de fragmentação da Eliminação de Duplicação de Dados como algo provável de ocorrer em outros arquivos semelhantes. |
