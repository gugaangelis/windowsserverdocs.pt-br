...
1. **Otimização não interferir as gravações no disco**  
...
2. **Otimização não deve alterar a semântica de acesso**  
...
## <a id="dedup-term"></a>Terminologia da eliminação de duplicação de dados
| Termo | Definição |
|------|------------|
...
| <a id="dedup-term-dedup"></a>eliminação de duplicação | Uma abreviação da Eliminação de Duplicação de Dados usada normalmente no PowerShell, em APIs e componentes do Windows Server e na comunidade do Windows Server. |
...
**Como a eliminação de duplicação de dados se diferem de outros produtos de otimização?**  
...
* *Como a eliminação de duplicação de dados se diferem de Store de instância única?*  
...
* *Como a eliminação de duplicação de dados difere dos formatos de arquivo morto como zip, rar, 7z, cab, etc.?*  
...
**Para monitorar os resultados históricos de trabalhos de eliminação de duplicação de dados?**  
...
**Pode alterar os agendamentos padrão para os trabalhos de eliminação de duplicação de dados em meu sistema?**  
