...
Esta seção discute problemas conhecidos com a Réplica de Armazenamento no Windows Server 2016.  
...
Esse problema foi corrigido na Atualização Cumulativa Windows 10 versão 1607 e Windows Server 2016: 9 de dezembro de 2016 (KB3201845). 
...
Erro de log de evento de Réplica de Armazenamento 10307:
...
Isso ocorre devido ao um problema de interoperabilidade entre a réplica de armazenamento e o SMB. Esse problema foi corrigido primeiramente em julho de 2017 na Atualização cumulativa do Windows Server 2016 e no Windows Server, versão 1709.
...
Observe o `Status: "{Access Denied}"` e a mensagem `A process has requested access to an object, but has not been granted those access rights.`. Esse é um problema conhecido na Réplica do armazenamento e foi corrigido na Atualização de qualidade em 12 de setembro de 2017 — KB4038782 (sistema operacional versão 14393.1715) https://support.microsoft.com/pt-br/help/4038782/windows-10-update-kb4038782 
...
Esse problema é ocasionado porque um ou mais discos não inicializados estão conectados a um ou mais nós de cluster. Para resolver o problema, inicialize todos os armazenamentos anexados usando DiskMgmt.msc, DISKPART.EXE ou o cmdlet Initialize-Disk do PowerShell.
...
Para resolver o problema, aumente o nível funcional do cluster, executando o cmdlet do PowerShell: Update-ClusterFunctionalLevel https://technet.microsoft.com/itpro/powershell/windows/failoverclusters/update-clusterfunctionallevel
