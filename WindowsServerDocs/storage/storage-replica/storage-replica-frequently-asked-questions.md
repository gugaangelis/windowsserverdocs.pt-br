...
## <a name="FAQ1"></a>Há suporte para réplica de armazenamento no Azure?
...
## <a name="FAQ2"></a>Como fazer ver o progresso da replicação durante a sincronização inicial?  
...
## <a name="FAQ3"></a>Posso especificar interfaces de rede específicas a serem usadas para replicação?  
...
## <a name="FAQ4"></a>Posso configurar replicação de um para muitos ou replicação transitiva (a para B para C)?  
...
## <a name="FAQ5"></a>Posso aumentar ou reduzir os volumes replicados replicados pela réplica de armazenamento?  
...
## <a name="FAQ6"></a>Posso colocar um volume de destino online para acesso somente leitura?  
...
## <a name="FAQ7"></a>Posso configurar o SOFS (servidor de arquivos de escalabilidade horizontal) em um cluster de ampliação?  
...
## <a name="FAQ8"></a>Posso configurar Espaços de Armazenamento Diretos em um cluster de ampliação com a réplica de armazenamento?  
...
## <a name="FAQ9"></a>Como fazer configurar a replicação assíncrona?  
...
## <a name="FAQ10"></a>Como fazer impedir o failover automático de um cluster de ampliação?  
...
## <a name="FAQ11"></a>Como fazer desabilitar a resiliência da máquina virtual?
...
## <a name="FAQ12"></a>Como reduzir o tempo para a sincronização inicial?
...
Você também pode usar volumes de dados propagados para reduzir o uso da largura de banda e, às vezes, o tempo, garantindo que o volume de destino tenha algum subconjunto de dados `New-SRPartnership`do primário, usando a opção propagada no Gerenciador de cluster de failover ou. Se o volume estiver quase vazio, usar a sincronização propagada pode reduzir o uso de largura de banda e economizar tempo. Há várias maneiras de propagar dados, com graus variados de eficácia:
...
## <a name="FAQ13"></a>Posso delegar os usuários para administrar a replicação?  
...
## <a name="FAQ13"></a>Quais são minhas opções de backup e restauração para volumes replicados?
...
## <a name="FAQ15"></a>Que portas de rede são necessárias para a réplica de armazenamento?
...
Outra A Microsoft recomenda enfaticamente que o armazenamento de log seja mais rápido do que o armazenamento de dados e que os volumes de log nunca devam ser usados para outras cargas de trabalho.
...
## <a name="FAQ16"></a>Por que você escolheria um cluster de ampliação versus uma topologia de cluster para servidor em comparação com servidor?  
...
## <a name="FAQ18"></a>A eliminação de duplicação de dados é suportada com a réplica de armazenamento?
...
## <a name="FAQ17"></a>Como fazer relatar um problema com a réplica de armazenamento ou este guia?  
...
- [Visão geral do armazenamento](../storage.md)  
