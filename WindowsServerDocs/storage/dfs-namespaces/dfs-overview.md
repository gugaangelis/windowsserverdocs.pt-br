...
Você pode administrar namespaces usando Gerenciamento DFS, o [Cmdlets de Namespace de DFS (DFSN) no Windows PowerShell](https://technet.microsoft.com/library/jj884270.aspx), o **DfsUtil** comando ou scripts que chamam o WMI.
...
Instale os Namespaces de DFS usando o Gerenciador do servidor ou do PowerShell, conforme descrito nas próximas seções.
...
Abra uma sessão do Windows PowerShell com direitos de usuário elevados e digite o comando a seguir, em que <name\> é o serviço de função ou recurso que você deseja instalar (consulte a tabela a seguir para ver uma lista de nomes de serviços de função ou recursos relevantes):
...
- Você pode hospedar namespaces baseados em domínio em máquinas virtuais do Azure, incluindo ambientes com Azure Active Directory, embora um único namespace não possa abranger nos servidores de namespace locais e servidores de namespace hospedados em máquinas virtuais do Azure, mesmo ao usar os Serviços de Federação do Active Directory (AD FS).
...
|**Implantação**|[Considerações de escalabilidade do Namespace DFS](http://blogs.technet.com/b/filecab/archive/2012/08/26/dfs-namespace-scalability-considerations.aspx)|
|**Operações**|[Namespaces do DFS: perguntas frequentes](http://technet.microsoft.com/library/ee404780.aspx)|
|**Recursos da comunidade**|[Fórum TechNet de serviços de arquivo e armazenamento](http://social.technet.microsoft.com/forums/winserverfiles/threads/)|
|**Protocolos**|[Protocolos do Windows Server e Serviços de Arquivos](http://msdn.microsoft.com/library/cc239875.aspx)|
