...
**Há dois canais de lançamento principal disponível para clientes do Windows Server, o canal de manutenção em longo prazo e o canal semestral.** 
...
## <a name="to-identify-windows-server-2019-and-windows-server-version-1809"></a>Para identificar o Windows Server 2019 e o Windows Server, versão 1809
