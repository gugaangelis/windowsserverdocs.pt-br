...
> - Tem dúvidas sobre outras versões? Confira as informações de [Novidades no Windows Server](../get-started/whats-new-in-windows-server.md).

**A lista está sujeita a alteração e pode não incluir todos os recursos ou funcionalidades afetadas.** 
