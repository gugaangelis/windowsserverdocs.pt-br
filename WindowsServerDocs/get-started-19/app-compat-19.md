...
| Host Integration Server 2016, CU3                            | Sim                                      |   | Sim                                             | Não            |   | [Requisitos de sistema do Host Integration Server](https://docs.microsoft.com/host-integration-server/install-and-config-guides/system-requirements)                                                            |
...
| Microsoft System Center Operations Manager 2019              | Sim\*                                    |   | Sim                                             | Não            |   | [Requisitos de sistema do System Center Operations Manager](https://docs.microsoft.com/system-center/scom/plan-system-requirements)                                                                                                      |
| Microsoft System Center Virtual Machine Manager 2019         | Sim\*                                    |   | Sim                                             | Não            |   | [Requisitos do sistema para o System Center Virtual Machine Manager](https://docs.microsoft.com/system-center/vmm/system-requirements)                                                                                                      |
| Microsoft System Center Data Protection Manager 2019         | Não                                       |   | Sim                                             | Não            |   | [Visão geral das opções de versão do System Center](https://docs.microsoft.com/system-center/ltsc-and-sac-overview)                                                                                                      |
...
\*Podem ter limitações ou pode exigir o [o recurso de compatibilidade de aplicativo do Server Core em demanda FOD (). ](install-fod-19.md)
