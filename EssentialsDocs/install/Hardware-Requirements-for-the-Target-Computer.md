...
## <a name="hardware-requirements-for-windows-server-essentials"></a>Requisitos de hardware para Windows Server Essentials  
 Você deve instalar o Windows Server Essentials no computador de destino que atenda os requisitos na tabela a seguir.  
 ...
 * Requisitos de hardware recomendados para dar suporte a máxima de usuários do Windows Server Essentials e limites do dispositivo.  
...
|Internet|Alguns recursos podem exigir acesso à Internet (poderão ser aplicadas taxas) ou uma Conta do Windows Live® ID|  
|Sistemas Operacionais Clientes com Suporte|-   Windows 7<br />-   Windows 8<br />-Macintosh OS X 10.5 a 10.8.<br /><br /> **Observação:** Alguns recursos podem exibir edições profissionais ou superiores.<br /><br /> 1 GB de espaço disponível no disco rígido (uma parte desse disco será liberada depois da instalação)|  
...
|Requisitos adicionais|Leitor de DVD-ROM|  
 ...
 Para obter mais informações sobre os requisitos de hardware, consulte o [Windows Server Catalog](http://www.windowsservercatalog.com).  
  
 Todo hardware de servidor deve atender aos requisitos estabelecidos para o programa de logotipo do Windows Server 2012 para sistemas. Para obter mais informações, consulte o [Programa de logotipo do Windows](https://www.microsoft.com/whdc/winlogo/hwrequirements.mspx).  
