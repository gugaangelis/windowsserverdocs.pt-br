...
1.  [Copiar dados para o servidor de destino](Move-Windows-SBS-2003-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md#BKMK_CopyData)  
...
3.  [Remover os scripts de logon antigo (opcionais)](Move-Windows-SBS-2003-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md#BKMK_RemoveScripts)  
...
6.  [Mapear os computadores permitidos para contas de usuário](Move-Windows-SBS-2003-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md#BKMK_MapPermittedComputers)  
...
##  <a name="BKMK_RemoveScripts"></a> Remover os scripts de logon antigo (opcionais)  
