---
title: Ingressar computadores para o novo network1 do Windows Server Essentials
...
---
# <a name="join-computers-to-the-new-windows-server-essentials-network1"></a>Ingressar computadores para o novo network1 do Windows Server Essentials
...
### <a name="domain-joined-client-computers"></a>Computadores cliente ingressado no domínio  
 Navegue até **http://***destino nomedoservidor***/ connect** e instalar o software do Windows Server Connector conforme se tiver havido um novo computador. O processo de instalação é o mesmo para os computadores cliente de domínio ou ingressado no domínio.  
...
### <a name="non-domain-joined-client-computers"></a>Computadores cliente não ingressados em domínio  
 Navegue até **http://***destino nomedoservidor***/ connect** e instalar o software do Windows Server Connector conforme se tiver havido um novo computador. O processo de instalação é o mesmo para ingressado no domínio ou computadores cliente conectados sem domínio.  
