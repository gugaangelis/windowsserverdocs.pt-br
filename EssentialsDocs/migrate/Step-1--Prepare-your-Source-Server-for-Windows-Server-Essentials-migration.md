...
1. A tabela a seguir fornece links para a Microsoft Download Center onde você pode baixar e instalar o Analisador de Práticas Recomendadas (BPA) para o servidor de origem.  
   ...
   | Windows SBS 2011 Essentials ou Windows SBS 2011 Standard |          [Windows Server Solutions Analisador de Práticas Recomendadas site](https://www.microsoft.com/download/details.aspx?id=15556)           |
