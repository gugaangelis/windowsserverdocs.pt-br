...
Este guia descreve como migrar um domínio existente do Windows Small Business Server 2011 Essentials para Windows Server® 2012 Essentials e, em seguida, migrar as configurações e dados. Este guia também descreve como remover seu servidor existente da rede do Windows Server Essentials depois de concluir a migração.  
