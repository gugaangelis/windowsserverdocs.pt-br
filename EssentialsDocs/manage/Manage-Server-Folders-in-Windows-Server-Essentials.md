...
>Aplica-se a: Windows Server 2016 Essentials, Windows Server 2012 R2 Essentials, Windows Server 2012 Essentials
 ...
 Como administrador do servidor, você pode gerenciar o acesso a quaisquer pastas de servidor (conhecido como pastas compartilhadas quando acessado a partir do Launchpad, acesso via Web remoto, o aplicativo My Server para Windows Phone ou aplicativo My Server para Windows 8) no servidor usando as tarefas no  **Pastas do servidor** no painel, permitindo aos usuários vários níveis de acesso a uma variedade de arquivos.  
  
 Os tópicos a seguir fornecem informações que ajudarão você a compreender, criar e gerenciar pastas do servidor:  
...
|Exibir as propriedades de pasta|Exibe as propriedades de uma pasta selecionada e permite que você:<br /><br /> -Altere o nome de pastas criadas pelo usuário.<br /><br /> -Altere a descrição de uma pasta selecionada.<br /><br /> -Exiba o tamanho da pasta.<br /><br /> -Abra a pasta selecionada no Explorador de arquivos.<br /><br /> -Especifique permissões de acesso de conta de usuário para uma pasta selecionada.<br /><br /> – Oculte uma pasta selecionada dos aplicativos de acesso via Web remoto e o serviço Web.<br /><br /> -Especifique a cota da pasta.|  
...
##  <a name="BKMK_1"></a> Gerenciar o acesso a pastas do servidor  
...
###  <a name="BKMK_Hide"></a> Ocultar pastas do servidor  
...
4.  No **< pasta do usuário\> tarefas** painel, clique em **exibir propriedades da pasta**.  
  
5.  Na **< FolderName\> Properties**, clique em **compartilhamento**, selecione **ocultar esta pasta de aplicativos de acesso via Web remoto e o serviço Web**e, em seguida, clique em **Aplicar**.  
...
###  <a name="BKMK_10"></a> Exibir ou modificar as propriedades de pasta do servidor  
...
> [!NOTE]
>  No Windows Server Essentials e no Windows Server 2012 R2 com a função experiência Windows Server Essentials instalada, você também pode modificar a cota da pasta.  
...
5.  Na **< Foldername\> propriedades**diante a **geral** guia, exiba ou modifique o nome e descrição da pasta do servidor.  
  
    > [!NOTE]
    >  No Windows Server Essentials e no Windows Server 2012 R2 com a função experiência Windows Server Essentials instalada, você também pode modificar a cota da pasta que emite uma mensagem de aviso quando uma pasta do servidor atinge seu tamanho especificado.  
  
##  <a name="BKMK_5"></a> Adicionar ou mover uma pasta do servidor  
...
-   Um diretório raiz de um disco rígido (como c:\\, unidade d:\\, e:\\)  
  
-   Uma subpasta de uma pasta compartilhada existente  
  
-   Um servidor membro executando o Windows Server Essentials ou Windows Server 2012 R2 com a função experiência Windows Server Essentials instalada  
...
##  <a name="BKMK_9"></a> Adicionar uma pasta de servidor ausente  
 Quando o servidor detecta que uma pasta predefinida do servidor? Empresa, usuários, Backups de computador cliente, Backup de histórico do arquivo ou redirecionamento de pasta? não está mais compartilhado (por algum motivo ou outro), um alerta é gerado para orientar o usuário para resolver esse problema. É recomendável que você tente restaurar a pasta do backup do servidor. No entanto, se o backup do servidor não tiver sido feito, selecione a pasta ausente e, em seguida, clique em **Recriar a pasta ausente** para reconfigurar o local da pasta do servidor.  
  
> [!NOTE]
>  Somente pastas predefinidas? Empresa, usuários, Backups de computador cliente, Backup de histórico do arquivo ou redirecionamento de pasta? podem ser recriados. Pastas do servidor criadas pelo usuário e pastas do servidor de mídia não podem ser recriadas.  
  
 Após a pasta ausente ser recriada ou restaurada, ele não deverá estar listada como **Ausente**.  
  
 Para obter informações sobre como restaurar arquivos de backup do servidor, consulte a seção Saiba mais sobre como restaurar arquivos e pastas no tópico [Manage Backup and Restore](Manage-Backup-and-Restore-in-Windows-Server-Essentials.md).  
  
##  <a name="BKMK_11"></a> Entender as pastas compartilhadas  
 Há várias maneiras diferentes de acessar as pastas compartilhadas no Windows Server Essentials a partir de um dispositivo conectado ao servidor. Para obter mais informações, consulte o tópico [Use Shared Folders](../use/Use-Shared-Folders-in-Windows-Server-Essentials.md).  
...
-   [Gerenciar o armazenamento de servidor](Manage-Server-Storage-in-Windows-Server-Essentials.md)  
