...
> [!IMPORTANT]
>   Somente há suporte para a integração com o Office 365 em um ambiente de controlador de domínio único. Além disso, o assistente de integração do Office 365 deve ser executado em um controlador de domínio.

## <a name="in-this-topic"></a>Neste tópico

-   [Por que devo integrar o Office 365 com meu servidor?](#BKMK_IntegrationOverview)

-   [Configurar a integração do Office 365](Manage-Office-365-in-Windows-Server-Essentials.md#BKMK_Configure)

-   [Gerenciar a integração com o Office 365](#BKMK_ManageIntegration)

-   [Solucionar problemas da integração com o Office 365](Manage-Office-365-in-Windows-Server-Essentials.md#BKMK_Troubleshoot)
...
3. **Vincule seu domínio da Internet personalizado à sua assinatura do Office 365.** Você usará a ação **vincular um domínio ao Office 365** .

4. **Verifique se seus serviços do Office 365 estão usando o novo nome de domínio.**
