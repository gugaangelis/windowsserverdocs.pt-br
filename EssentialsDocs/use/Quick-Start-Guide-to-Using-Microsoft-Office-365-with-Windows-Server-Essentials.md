...
> [!IMPORTANT]
>  Se você perder um dispositivo móvel que você usa para se conectar ao Exchange Online, entre em contato com seu administrador para que sejam removidos confidenciais a dados do dispositivo na próxima vez que ele s ativada.  
  
### <a name="before-you-begin"></a>Antes de começar  
  
1.  Você deve ter uma conta do Microsoft Online Services (no Windows Server Essentials, ele s chamado um *conta do Office 365*) atribuído à sua conta de usuário. Se você não t já tem uma conta online para Office 365, peça à pessoa que mantém a sua rede de computadores para criar uma para você.  
...
2.  Clique em **SharePoint Online**.  
    ...
    > [!NOTE]
    >  Se você não encontrar **SharePoint Online**, peça ao seu administrador se o Office 365 foi integrado com o servidor.  
  
3.  Clique em uma biblioteca do SharePoint Online para exibir os documentos na biblioteca.  
  

     Você pode abrir, editar, carregar e baixar documentos na biblioteca do SharePoint Online da mesma maneira que trabalha com documentos no servidor ou no OneDrive. Para obter mais informações, consulte [usar o aplicativo My Server](Use-the-My-Server-App-to-Connect-to-Windows-Server-Essentials.md).  

     Você pode abrir, editar, carregar e baixar documentos na biblioteca do SharePoint Online da mesma maneira que trabalha com documentos no servidor ou no OneDrive. Para obter mais informações, consulte [usar o aplicativo My Server](../use/Use-the-My-Server-App-to-Connect-to-Windows-Server-Essentials.md).  
