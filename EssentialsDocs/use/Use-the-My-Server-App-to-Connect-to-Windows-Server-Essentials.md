...
#### <a name="to-install-my-server-or-my-server-2012-r2-on-your-windows-based-laptop-pc-or-surface-device"></a>Para instalar meu servidor ou meu servidor 2012 R2 em seu dispositivo laptop, PC ou Surface baseado no Windows  
...
-   [Visão geral da integração de serviços para o Windows Server Essentials-parte 1](http://blogs.technet.com/b/sbs/archive/2013/11/06/services-integration-overview-for-windows-server-2012-r2-essentials-part-1.aspx)  
  
-   [Visão geral da integração de serviços para o Windows Server Essentials-parte 2](http://blogs.technet.com/b/sbs/archive/2013/11/06/services-integration-overview-for-windows-server-2012-r2-essentials-part-2.aspx)  
